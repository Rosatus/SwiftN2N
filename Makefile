...
.PHONY: doctor test frontend-install frontend-build frontend-test audit compliance edge-linux-amd64 prepare-edge bundle-edge-linux build-current package-current build-linux release-linux dev-linux clean
